...
const setPublicMint = async (URI,contractAddr, blockNum, price, ownerAddress, totaltokenNum=100, startTokenidx=0) => {
    ...
    try {
        ...
        await contract.methods.setupSale(5,1,3,blockNum,startTokenidx,totaltokenNum,price).send({
            from: account.address,
            gas: '10000000',
            value: '0',
        }).then(console.log)
